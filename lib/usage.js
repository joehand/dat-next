module.exports = function (opts) {
  ...
  console.error('   dat-next create                        create a local archive')
  console.error('   dat-next snapshot                      create a local snapshot archive')
  console.error('   dat-next clone <dat-link> <directory>  clone a remote archive')
  console.error('')
  console.error('   dat-next sync                          sync files with the network')
  console.error('   dat-next pull                          update from remote archive & exit')
  console.error('')
  ...
  console.error('     --debug                         print debugging information')
